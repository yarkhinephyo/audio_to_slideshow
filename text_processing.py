    ...
    for j, sentence in enumerate(sentences):
        ...
        for word in words:
            if word in timestamps[i][0]:
                word_timestamps.append((word, timestamps[i][1], timestamps[i][2]))
                i += 1
...
if __name__ == '__main__':
    ...
    timestamps = [['this', 1.58, 1.79], ['is', 1.79, 1.89], ['a', 1.89, 1.98], ['test', 1.98, 2.32], ['when', 2.8, 2.97], ['I', 2.97, 3.03], ['talk', 3.03, 3.33], ['about', 3.33, 3.62], ['dog', 3.62, 4.03], ['does', 4.43, 4.66], ['the', 4.66, 4.82], ['video', 4.82, 5.23], ['show', 5.23, 5.51], ['pictures', 5.51, 6.03], ['of', 6.03, 6.21], ['dogs', 6.21, 6.65], ['and', 6.74, 6.96], ['cats', 7.22, 7.55], ['if', 8.04, 8.22], ['it', 8.22, 8.36], ['does', 8.36, 8.77], ['then', 9.02, 9.22], ['I', 9.22, 9.35], ['will', 9.35, 9.53], ['celebrate', 9.53, 10.13]]
